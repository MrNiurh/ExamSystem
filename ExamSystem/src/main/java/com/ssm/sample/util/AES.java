...
public class AES {
	 ...
	 * 密钥
	 */
	private static final String KEY = "abcdefg12qwertyu";
	...
	public static void main(String[] args) throws Exception {
		String content = "你好，欢迎来到开源中国在线工具，这是一个AES加密测试";
	...
	public static String aesDecrypt(String encryptStr, String decryptKey) throws Exception {
		return "".equals(encryptStr) ? null : aesDecryptByBytes(base64Decode(encryptStr), decryptKey);
	}
}
